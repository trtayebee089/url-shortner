...
async function submit() {
  ...
  try { const response = await request<ApiEnvelope<LinkRecord>>('links', { method: 'POST', body: { destination_url: destinationUrl.value, custom_alias: customAlias.value || null } }); result.value = response.data; show('Short link created.') }
